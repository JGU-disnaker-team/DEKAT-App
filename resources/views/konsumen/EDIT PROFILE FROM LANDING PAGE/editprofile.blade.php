...
<div class="edit-profile-container">
    ...
    <div class="profile-photo">
        <div class="circle"></div>
        <button class="change-photo">Ganti Foto</button>
    </div>

    <div class="form-group">
        <label for="first-name">Nama Depan</label>  
        <input type="text" id="first-name" value="Ocin">
    </div>

    <div class="form-group">
        <label for="last-name">Nama Belakang</label>
        <input type="text" id="last-name" value="Leonardo">
    </div>

    <div class="form-group">
        <label for="email">Email</label>
        <input type="email" id="email" value="ocinleo@gmail.co.id">
    </div>

    <div class="form-group">
        <label for="phone">Nomor Ponsel</label>
        <input type="text" id="phone" value="081212121212121">
    </div>

    <div class="form-group">
        <label for="address">Alamat</label>
        <textarea id="address">Pasir putih, Sawangan, Kota Depok, Jawa Barat, +6281111xxxxxx</textarea>
    </div>

    <div class="form-group">
        <label for="city">Kota</label>
        <input type="text" id="city" value="Depok">
    </div>

    <div class="form-group">
        <label for="province">Provinsi</label>
        <input type="text" id="province" value="Jawa Barat">
    </div>
    ...
    <div id="confirmation-dialog" class="confirmation-dialog">
        <p>Apakah kamu yakin untuk menyimpan perubahan?</p>
        <button id="confirm-yes" class="confirm-button">Ya</button>
        <button id="confirm-no" class="cancel-button">Tidak</button>
    </div>
</div>    
...
<script>
    ...
    document.getElementById('confirm-yes').addEventListener('click', function() {
        ...
        alert('Perubahan disimpan!'); // Ganti dengan logika penyimpanan yang sesuai
