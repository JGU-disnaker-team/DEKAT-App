...
<body>
    <div class="payment-card">
        ...
        <button class="btn btn-primary w-100 mt-4" onclick="showCheckAlert()">Cek Status Pembayaran</button>
        <!-- </a> -->
    </div>
...
/* Tambahkan CSS untuk alert */
    ...
    if (isPaid) {
        showSuccessAlert();
        window.location.href = "infopemesanan.blade.php"; // Redirect setelah alert
        } else {
        showAlert(); // Tampilkan alert jika belum bayar
            }
    }
    ...
    if (isPaid) {
        ...
        setTimeout(() => {
            window.location.href = "selesaipembayaran.blade.php"; // Redirect setelah alert sukses
