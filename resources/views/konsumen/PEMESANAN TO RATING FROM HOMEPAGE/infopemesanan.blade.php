...
<head>
    ...
    <div class="tab-status">
        <a href="   ">
            <button class="tab-button active">Menunggu</button>
        </a>
    ...
    <!-- Bagian Informasi Teknisi -->
    <div class="teknisi-info">
        <h2>Teknisi kamu sedang menuju lokasi anda</h2>
        <div class="card">
            <div class="card-content">
                <img src="assets/fototeknisi2.png" alt="Ahmad Teknik" class="teknisi-image">
                <div class="teknisi-details">
                    <h3>Ahmad Teknik</h3>
                    <p>Service AC</p>
                    <div class="rating">
                        <span>⭐⭐⭐⭐⭐</span> <!-- Rating -->
