...
<head>
    ...
    <style>
        .notification-container {
            ...
            position: absolute; /* Atur posisi sesuai kebutuhan */
        ...
        .notification-item.active {
            background-color: #e0f7fa; /* Warna latar belakang untuk notifikasi aktif */
        }
...
<body>
    <nav>
        ...
        <ul class="nav_links">
            ...
            <li class="link"><a href="receiver.blade.php"><i class="fas fa-comment-alt"></i></a></li> <!-- Profile Icon -->
            <li class="link">
                <a href="#" onclick="showNotification()"><i class="fas fa-bell"></i></a> <!-- Ikon Notifikasi -->
            </li>
                <div class="link">
                    <!-- Ikon Profil -->
    ...
    <div class="notification-container" id="notificationContainer">
        ...
        <div class="notification-item">
            <p>No Pesanan: 134345653 Telah Selesai</p>
            <span>2 Jam yang lalu</span>
            <a href="#" class="view-link">Lihat</a>
        </div>
        <div class="notification-item active">
            <p>Pengajuan biaya tambahan</p>
            <span>2 Jam yang lalu</span>
            <a href="notification.blade.php" class="view-link">Lihat</a>
        </div>
        <div class="notification-item">
            <p>Teknisi menuju lokasi anda</p>
            <span>3 Jam yang lalu</span>
            <a href="#" class="view-link">Lihat</a>
        </div>
        <div class="notification-item">
            <p>Teknisi Mengirimkan anda pesan</p>
            <span>3 Jam yang lalu</span>
            <a href="#" class="view-link">Lihat</a>
        </div>
        <div class="notification-item">
            <p>pembayaran Virtual Account 134345653xx, Berhasil</p>
            <span>6 Jam yang lalu</span>
            <a href="#" class="view-link">Lihat</a>
        </div>
        <div class="notification-item">
            <p>Menunggu pembayaran Virtual Account 134345653xxx</p>
            <span>6 Jam yang lalu</span>
            <a href="#" class="view-link">Lihat</a>
        </div>
        <div class="notification-item">
            <p>Kamu telah berhasil mengganti kata sandi</p>
            <span>Jam yang lalu</span>
            <a href="#" class="view-link">Lihat</a>
        </div>
    </div>
...
function closeNotification() {
    ...
    notificationContainer.style.display = 'none'; // Menyembunyikan kontainer notifikasi
}

// Contoh untuk menampilkan notifikasi (bisa dipanggil sesuai kebutuhan)
function showNotification() {
    const notificationContainer = document.getElementById('notificationContainer');
    notificationContainer.style.display = 'block'; // Menampilkan kontainer notifikasi
}
</script>  