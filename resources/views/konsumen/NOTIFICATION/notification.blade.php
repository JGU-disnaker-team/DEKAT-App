...
<head>
    ...
    <div class="notification-container">
        <h1>Notifikasi</h1>
         <h2>PEMESANAN</h2>
         <p>No Pesanan: 134345653 Telah Selesai, harap memberi rating kepada layanan kami dan teknisi. Jika anda mengalami kendala harap hubungi layanan kami, terkait untuk garansi anda dapat melihat syarat dan ketentuan kami.</p>
        <a href="index.blade.php" class="btn">Kembali</a>
    </div>
